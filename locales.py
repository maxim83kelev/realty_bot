TEXTS = {
    "ru": {
        ...
        "ask_disposition": "🚪 Сколько комнат? Отметь все подходящие и нажми «Готово»:",
        "disp_studio": "Студия / 1+kk",
        "disp_2": "2 комнаты (2+kk, 2+1)",
        "disp_3": "3 комнаты (3+kk, 3+1)",
        "disp_4": "4 и больше",
        "disp_2_short": "2",
        "disp_3_short": "3",
        "disp_rooms_line": "🚪 Комнаты: {rooms}",
        "disp_any": "Любая планировка",
        "disp_done": "✅ Готово",
    ...
    "cs": {
        ...
        "ask_disposition": "🚪 Kolik pokojů? Označ všechny vyhovující a klikni „Hotovo“:",
        "disp_studio": "Garsonka / 1+kk",
        "disp_2": "2 pokoje (2+kk, 2+1)",
        "disp_3": "3 pokoje (3+kk, 3+1)",
        "disp_4": "4 a více",
        "disp_2_short": "2",
        "disp_3_short": "3",
        "disp_rooms_line": "🚪 Pokoje: {rooms}",
        "disp_any": "Jakékoli uspořádání",
        "disp_done": "✅ Hotovo",
